...
export default function App() {
  ...
  async function doOpportunityDecision() {
    ...
    if ((oppDecision === "REJECT" || oppDecision === "MODIFY") && !oppNote.trim()) {
      setError(`Per ${oppDecision} devi inserire una motivazione testuale.`);
      setMessage("");
      return;
    }
              ...
              <article className="panel">
                ...
                <div className="form-grid">
                  ...
                  <input
                    ...
                    placeholder={oppDecision === "APPROVE" ? "note opzionali" : "motivazione obbligatoria"}
                  />
                </div>
                <div className="actions">
