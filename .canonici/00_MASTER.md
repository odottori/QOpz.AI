...
â”‚    + TWAP/VWAP for Wide Spreads [OPERATIONAL only] [v11.1]                    â”‚
...
6.1 Iron Condor IWM (STARTER Tier)
...
7. TIER PROGRESSIONE
STARTER (â‚¬3,000â€“â‚¬10,000)
Strategie: Iron Condor IWM, Bull Put Spread
Max posizioni: 2-3
Sizing: Fixed fractional 5-10% per trade
Obiettivo: 8-15% annuo, learning curve
OPERATIONAL (â‚¬10,000+)
Aggiunta: Wheel strategy, multi-underlying
Sizing: Kelly fractional
Hedge: Put spread mensile attivo
Obiettivo: 15-25% annuo
8. PIANO IMPLEMENTAZIONE 90 GIORNI

Settimana	Focus	Deliverable	Validazione
1-2	Setup ambiente, pipeline dati	Database DuckDB, IVR calcolato	Match ORATS <5%
3-4	Regime base + HMM [v11.1]	Report WFA 5 fold	Sharpe >0.5
5-6	IBKR paper trading	5 trade eseguiti	Zero errori
7-10	Scoring 4-pilastri + Kelly [v11.1]	Confronto vs regime base	Miglioramento >0.1 Sharpe
11-12	Kelly skewness + DD control	Simulazione stress	Trigger corretti
13+	Paper completo 60 giorni	Journal, metriche stabili	GO/NO-GO
...
- Appendice A: Walkthrough Operativo End-to-End (CET) â€“ `03_APPENDICE_WALKTHROUGH_OPERATIVO.md`
- Appendice B: Moduli Avanzati (Non Canonici) â€“ Delta Overlay â€“ `04_APPENDICE_MODULI_AVANZATI_DELTA_OVERLAY.md`
...
### STARTER-LITE (Percorso minimo certificabile)
Per utenti retail/entry, il percorso minimo certificabile Ã¨ **STARTER-LITE**:
...
### Execution Policy (STARTER-LITE vs OPERATIONAL)
- **STARTER-LITE**: esecuzione semplificata (ordine singolo o ladder aggressiva) su sottostanti liquidi; TWAP/VWAP non richiesti.
- **OPERATIONAL**: TWAP/VWAP ammessi quando la liquiditÃ /spread lo giustificano e con logging dei slice.
...
Questa policy evita â€œfalse precisionâ€ su sample piccoli e mantiene progressione STARTER-LITE â†’ STARTER â†’ OPERATIONAL.
